...
const OrderConfirmation = () => {
  const trackingId = sessionStorage.getItem("confirmed_tracking_id") || "";
      ...
      <div className="flex min-h-[60vh] items-center justify-center">
        ...
        >
          {trackingId ? (
            ...
            <>
              <h1 className="font-display text-2xl font-bold text-white">No Active Booking</h1>
              <p className="mt-2 text-white/50 mb-6">We couldn't find any recent booking confirmation details in your session.</p>
              <Link to="/user/book">
                <Button className="bg-gradient-to-r from-orange-500 to-violet-600 text-white font-bold hover:opacity-90">Book A Parcel</Button>
              </Link>
            </>
          )}
        </motion.div>
